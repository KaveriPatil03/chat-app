      ...
      {!joined ? (
        <div className="flex w-full max-w-3xl mx-auto flex-col items-center">
          ...
          <input
            ...
            className="flex-1 px-4 py-2 mb-4 border-gray-200 border-2 rounded-lg"
          />
          <input
            type="text"
        ...
        <div className="w-full max-w-3xl mx-auto ">
          ...
          <div className="h-[500px] overflow-y-auto p-4 mb-4 bg-gray-200 border-gray-300 border-2 rounded-lg">
